<?php
namespace Sms\IpPanel;
use Exception;
use Sms\IpPanel\Models\InboxMessage;
use Sms\IpPanel\Models\Message;
use Sms\IpPanel\Models\PaginationInfo;
use Sms\IpPanel\Models\Pattern;
use Sms\IpPanel\Models\Recipient;
class Client
{
    const ENDPOINT = '';
    /**
